...
# This was renamed from misc_analysis in aug2021 directory
...
print(np.corrcoef(upper,lower))
print(np.corrcoef(upper_nodiag,lower_nodiag))
...
s = (np.linalg.norm(B_sym, ord='fro') - np.linalg.norm(B_anti, ord='fro'))/(np.linalg.norm(B_sym, ord='fro') + np.linalg.norm(B_anti, ord='fro'))
print(s)
