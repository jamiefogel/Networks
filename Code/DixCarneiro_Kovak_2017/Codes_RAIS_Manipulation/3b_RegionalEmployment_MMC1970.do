...
* Aggregation level of regions: micro-regions consistent between 1970 and 2010.
...
log using ${result}RegionalEmployment_MMC1970.log, replace
...
save ${result}mmcEmployment_mmc1970_1986_2010, replace
