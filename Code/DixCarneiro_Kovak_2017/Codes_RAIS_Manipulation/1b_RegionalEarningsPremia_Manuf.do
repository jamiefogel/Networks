...
* from the raw RAIS data (1986 to 2010). Only manufacturing jobs are kept.
...
log using ${result}RegionalEarnPremia_Manuf.log, replace
...
save ${result}mmcEarnPremia_manuf_1986_2010, replace
