...
* No industry fixed effects in the first-stage Mincerian regressions.
...
log using ${result}RegionalEarnPremia_NoIndFE.log, replace
...
forvalues year = 1986/2009{
	...
	* Regression without a constant: we recover parameters for all mmc's
	reg log_rem region1-region`number_mmc' female age2-age5 educ2-educ9, noc vce(robust)
...
save ${result}mmcEarnPremia_noindfe_1986_2010, replace
