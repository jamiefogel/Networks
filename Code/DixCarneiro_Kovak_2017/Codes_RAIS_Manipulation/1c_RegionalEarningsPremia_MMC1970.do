...
* Here, we use another level of regional aggregation: we use micro-regions
* that are consistent between 1970 and 2010.
...
log using ${result}RegionalEarnPremia_MMC1970.log, replace

set min_memory 21g

* correspondence between municialities and mmc's
use ${data2}rais_codemun_to_mmc_1970_2010
tostring mmc, replace
sort mmc
save ${data2}rais_codemun_to_mmc_1970_2010, replace
...
forvalues year = 1986/2009{
	...
	* Merge to get mmc codes
    sort codemun
	merge m:1 codemun using ${data2}rais_codemun_to_mmc_1970_2010
	keep if _merge == 3
	drop _merge
...
save ${result}mmcEarnPremia_mmc1970_1986_2010, replace
