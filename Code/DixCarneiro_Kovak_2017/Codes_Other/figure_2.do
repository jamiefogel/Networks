...
*
* Generates the data underlying Figure 2, showing regional tariff reductions.
*
* Output: figure_2.csv - data for map in Figure 2
*         /Data/rtc_kume.dta
******************************************************************************

cd "${root}Codes_Other"
log using figure_2.txt, text replace
