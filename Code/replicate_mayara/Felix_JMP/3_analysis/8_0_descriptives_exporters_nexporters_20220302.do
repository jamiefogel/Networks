...
twoway 	(kdensity lnemp if bexp==1 & T==1, color(blue%30) recast(area) bwidth(0.45)) ///
		(kdensity lnemp if bexp==0 & T==1, color(red%30) recast(area) bwidth(0.45)) ///
		(kdensity lnemp if T==0, color(gs10%30) recast(area) bwidth(0.45)), ///
		xline(`mexp', lpattern(dash) lcolor(red)) text(.25 `mexp' " Avg. `exp'" "employees", place(ne) color(blue)) ///
		xline(`mno', lpattern(dash) lcolor(blue))  text(.27 `mno'  " Avg. `no'" "employees", place(ne) color(red)) ///
...
twoway 	(kdensity lnwage if bexp==1 & T==1, color(blue%30) recast(area) bwidth(0.25)) ///
		(kdensity lnwage if bexp==0 & T==1, color(red%30) recast(area) bwidth(0.25)) ///
		(kdensity lnwage if T==0, color(gs10%30) recast(area) bwidth(0.25)), ///
		xline(`mexp', lpattern(dash) lcolor(red)) text(.45 `mexp' " `exp' x min wage", place(ne) color(blue)) ///
		xline(`mno', lpattern(dash) lcolor(blue))  text(.55 `mno'  " `no' x min wage", place(nw) color(red)) ///	
