...
capture log close 
log using "${encrypted}/logs/1_4_earnings_premia_job_blocks_level_0_jid.log", replace
...
if `premia'==1{
	...
	*********** Append across years *******
	...
	gduplicates drop
	compress
	saveold "${monopsonies}/sas/rais_lnearn_premia_firm_job_blocks_level_0_`outdate'.dta", replace
}
