...
capture log close 
log using "${encrypted}/logs/1_4_earnings_premia_gamma_firm.log", replace
...
if `premia'==1{
	...
	*********** Append across years *******
	...
	gduplicates drop
	compress
	saveold "${monopsonies}/sas/rais_lnearn_premia_firm_gamma_`outdate'.dta", replace
}
