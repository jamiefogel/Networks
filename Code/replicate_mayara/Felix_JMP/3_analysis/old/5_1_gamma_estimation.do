...
local gamma					= 1		/* Get Gamma estimate */
...
if `graphs'==1{
		...
		ytitle("LLM average wage take-home share", size(small)) yscale(titlegap(*5))

		graph export "${monopsonies}/eps/`outdate'/DD_gamma.pdf", replace
