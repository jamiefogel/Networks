...
if `setup'==1{
  ...
  foreach sampfile in 1 0 {
		...
		* Log employment
		...
		compress
		saveold "${monopsonies}/sas/eta_changes_regsfile`sampfile'_3states.dta", replace
...
if `eta_regs'==1{
	...
	u "${monopsonies}/sas/eta_changes_regsfile`usesample'_3states.dta", clear
...
pause			
	...
	** Append all main regression coefficients and export to csv ***
	...
	duplicates drop
	outsheet using "${monopsonies}/csv/`outdate'/eta_change_regressions_3states.csv", comma replace
	...
	******************************************************************************
	...
	duplicates drop
	compress
	saveold "${monopsonies}/dta/coeffs/`outdate'/eta_change_delta_ro_3states.dta", replace
