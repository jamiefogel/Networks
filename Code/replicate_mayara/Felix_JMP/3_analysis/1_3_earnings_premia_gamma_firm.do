...
capture log close 
log using "${encrypted}/logs/1_3_earnings_premia_gamma_firm.log", replace
...
if `premia'==1{
	...
	forvalues y=`yearfirst'(1)`yearlast'{		
		...
		* Use same categories as DK
		...
		gegen double fe_zro = group(fakeid_firm gamma)
		...
		****************** MMC premia (excl. industry) ****************
		...
		keep fakeid_firm gamma dprem_zro davgw_zro
		gduplicates drop
