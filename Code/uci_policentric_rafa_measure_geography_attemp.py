...
test = raw[['lat_munic','lon_munic']][raw['iota']==iota]
# Create a GeoDataFrame
gdf = gpd.GeoDataFrame(
    test,
    geometry=gpd.points_from_xy(test.lon_munic, test.lat_munic),
    crs='EPSG:4326'  # Assuming your coordinates are in WGS84
)
uci_result = uci(gdf, 'workers')
print(uci_result)