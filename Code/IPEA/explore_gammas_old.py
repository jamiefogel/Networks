...
distances = distances.merge(jid_muni.rename(columns={'jid':'jid_prev','lat':'lat_prev','lon':'lon_prev'}), on='jid_prev', validate='m:1', indicator='_merge_prev')
distances = distances.merge(jid_muni, left_on='jid', right_on='jid', validate='m:1', indicator='_merge')
...
gammas_w_attributes = gammas_w_attributes.merge(distance_stats, left_on='gamma_0', right_on='gamma', validate='1:1')
...
print(gammas_w_attributes.drop(columns=['gamma_0','modal_ind2','modal_sector','dist_min']).corr())
'''
...
gammas_w_attributes = gammas_w_attributes.merge(spatial_var_km, left_on='gamma_0', right_on='gamma', how='left', validate='1:1')
